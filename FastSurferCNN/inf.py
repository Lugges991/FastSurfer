...
def options_parse():
    ...
    parser.add_argument('--i_txt', help="txt file where each line contains the absolute path to a T1 file") 
    ...
    if sel_option.input is None and sel_option.csv_file is None and sel_option.i_txt is None and not sel_option.simple_run:
